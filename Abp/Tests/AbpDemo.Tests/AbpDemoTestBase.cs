...
namespace AbpDemo.Tests
{
    public abstract class AbpDemoTestBase : AbpIntegratedTestBase<AbpDemoTestModule>
    {
        ...
        protected Task UsingDbContextAsync(Func<AbpDemoDbContext, Task> action)
        {
        ...
        protected Task<T> UsingDbContextAsync<T>(Func<AbpDemoDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<AbpDemoDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<AbpDemoDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<AbpDemoDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<AbpDemoDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<AbpDemoDbContext, Task<T>> func)
        {
            T result;
